...
describe("packages", function() {
	...
	describe(".loadPackages", function() {
		it("should display report about loading packages", function(done) {
			// Mock `log.info` to extract its effect into an array
			const stdout = [];
			log.info = TestUtil.mockLogger((str) => stdout.push(str));
